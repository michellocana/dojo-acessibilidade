  ...
  return [
    <Slide>
      ...
      <Text textColor='secondary' textSize={40}>
        Sim, parallax foi um design trend muito usado no passado, e ainda é um pouco até hoje mas ao
        mesmo tempo que (se usado da forma correta) ele pode deixar a experiência do usuário mais
        interessante e atrativa, ele pode prejudicar a experiência de outros usuários
      </Text>
    </Slide>,
    ...
    <Slide>
      ...
      <Appear>
        <Text textColor='secondary' textSize={40}>
          ...
          coisas se mexendo em velocidades diferentes, em primeiro e segundo plano (também conhecido
          como parallax).
        </Text>
      </Appear>

      <Notes>
        Isso não quer dizer que o parallax tenha que deixar de ser usado, mas só que deve ser usado
        com cuidado, e de forma sútil
      </Notes>
    </Slide>
  ]
}
